...
Wlls.MIS_UI 	= 
{
	[1] = {"<color=gold>%s Vs %s\n\n", "<color=green>Thời gian bắt đầu: <color=white>%s<color>\n\n", "<color=green>Sát thương phe địch: <color=red>%s\n<color=green>Sát thương phe ta: <color=blue>%s"};
...
Wlls.MIS_UI_LOOKER = "<color=green>Lượng máu tổn thất đội %s: <color=red>\n    %s\n\n<color=green>Lượng máu tổn thất đội %s: \n    <color=blue>%s";
