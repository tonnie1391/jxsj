...
Relation.emKEPLAYER_NOTONLINE	= 3	-- 对方不在线的时时不能添加为Hảo hữu
...
--Player.emKPLAYERRELATION_TYPE_TMPFRIEND		= 0;		-- 临时Hảo hữu，单向关系，A把B加为临时Hảo hữu
--Player.emKPLAYERRELATION_TYPE_BLACKLIST		= 1;		-- 黑名单，单向关系，A把B加入黑名单
--Player.emKPLAYERRELATION_TYPE_BIDFRIEND		= 2;		-- 普通Hảo hữu, 对等双向关系，A和B互为Hảo hữu
...
--Player.emKPLAYERRELATION_TYPE_BUDDY			= 9;		-- 指定密友，双向对等关系，A和B互为密友同时也互为普通Hảo hữu
--Player.emKPLAYERRELATION_TYPE_COUNT			= 10;
--Player.emKPLAYERRELATION_TYPE_GLOBALFRIEND	= 100;		-- 跨服Hảo hữu，此关系只用人际面板来显示，并不使用人际关系的逻辑



Relation.tbRelationName = {
	[Player.emKPLAYERRELATION_TYPE_TMPFRIEND] = "Hảo hữu",	-- 临时Hảo hữu
	[Player.emKPLAYERRELATION_TYPE_BLACKLIST] = "Sổ đen",
	[Player.emKPLAYERRELATION_TYPE_BIDFRIEND] = "Hảo hữu",
	[Player.emKPLAYERRELATION_TYPE_SIBLING] = "Kết bái",
	[Player.emKPLAYERRELATION_TYPE_ENEMEY] = "Cừu nhân",
	[Player.emKPLAYERRELATION_TYPE_TRAINING] = "Sư đồ",
	[Player.emKPLAYERRELATION_TYPE_TRAINED] = "Sư đồ",
	[Player.emKPLAYERRELATION_TYPE_COUPLE] = "Tri kỷ",
	[Player.emKPLAYERRELATION_TYPE_INTRODUCTION] = "Tiến cử",
