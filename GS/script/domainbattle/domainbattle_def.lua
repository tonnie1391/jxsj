...
JUNXU_MEDICINE_NAME = {  
				[JUNXU_MEDICINE] = {[1783] = "Hồi Huyết Đơn",
									[1784] = "Hồi Nội Đơn", 
									[1785] = "Càn Khôn Tạo Hóa Hoàn"}
			 };
...
OPENSTATE_TO_LEVEL = 
{
	[1] = {nNpcLevel = 55, 	nSkillLevel = 4, szOpenState = "OpenLevel89", 	nOffsetDay = 7},
	[2] = {nNpcLevel = 55, 	nSkillLevel = 4, szOpenState = "OpenLevel99", 	nOffsetDay = 0},
	[3] = {nNpcLevel = 55,	nSkillLevel = 4, szOpenState = "OpenLevel150", 	nOffsetDay = 0},
	[4] = {nNpcLevel = 55,	nSkillLevel = 4, szOpenState = "OpenLevel150", 	nOffsetDay = 150},
}
