...
{
	[1] = {szBase = "Vật Báu Lâu Lan-Ngọc Bích", szName = "Mảnh tay Bích Huyết", tbBaseId = {18, 1, 1235, 1}, tbItemId = {18, 1, 1237, 1}, nNeedChip = 10, nNeedMoon = 3},
	[2] = {szBase = "Vật Báu Lâu Lan-Linh Tinh", szName = "Mảnh tay Kin Lân", tbBaseId = {18, 1, 1235, 2}, tbItemId = {18, 1, 1238, 1}, nNeedChip = 10, nNeedMoon = 10},
	[3] = {szBase = "Vật Báu Lâu Lan-Nhã Từ", szName = "Mảnh nhẫn Bích Huyết", tbBaseId = {18, 1, 1236, 1}, tbItemId = {18, 1, 1240, 1}, nNeedChip = 10, nNeedMoon = 4},
	[4] = {szBase = "Vật Báu Lâu Lan-Bạch Ngọc", szName = "Mảnh nhẫn Kim Lân", tbBaseId = {18, 1, 1236, 2}, tbItemId = {18, 1, 1241, 1}, nNeedChip = 10, nNeedMoon = 13},
};

-- 材料列表
Atlantis.ITEM_CHIP_ID = 
{
	[1] = {tbItemId = {18, 1, 1235, 1}, szName = "Vật Báu Lâu Lan-Ngọc Bích"},
	[2] = {tbItemId = {18, 1, 1235, 2}, szName = "Vật Báu Lâu Lan-Linh Tinh"},
	[3] = {tbItemId = {18, 1, 1236, 1}, szName = "Vật Báu Lâu Lan-Nhã Từ"},
	[4] = {tbItemId = {18, 1, 1236, 2}, szName = "Vật Báu Lâu Lan-Bạch Ngọc"},
};
