...
function tbNpc:OnDeath(pNpcKiller)
	...
	if pPlayer then
		...
		SuperBattle:SendMessage(pPlayer, SuperBattle.MSG_CHANNEL, string.format("Hạ gục <color=yellow>%s<color>, nhận <color=yellow>%s điểm<color> chiến tích.", him.szName, SuperBattle.KILL_ADMIRAL_POINT));
