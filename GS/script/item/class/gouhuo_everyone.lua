...
tbGouhuoItem.nDelayTime		= 1;	-- 拾取篝火时会延时5(秒) 
...
function tbGouhuoItem:PickUp(nX, nY)
	local nExistentTime = 0;	--持续时间
	local nBaseMultip = 0;		--经验倍率
...
function tbGouhuoItem:DelayTime(pPlayer, nObjId)
	GeneralProcess:StartProcess("Đang đốt lửa...", 1 * Env.GAME_FPS, {self.DoPickUp, self, pPlayer.nId, nObjId}, nil, tbEvent);
end
...
function tbGouhuoItem:CallGouhuoNpc(nX, nY, nExistentTime, nBaseMultip)
	...
	tbNpc:InitGouHuo(pNpc.dwId, 0,	nExistentTime, self.nDelayTime, 100, nBaseMultip, 0)
