...
local tb	= Task:GetTarget("AddObjByMutiMap");
tb.szTargetName	= "AddObjByMutiMap";

function tb:Init(tbItemId, nNpcTempId, szNewName, szMapType, nPosX, nPosY, nR, szPosName, szMsg)
...
function tb:GetStaticDesc()
	return string.format("Đem %s đặt ở %s", self.szNpcName, self.szPosName);
end;
