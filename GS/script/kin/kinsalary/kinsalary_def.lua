...
{
	[1] = {szKey = "SalaryXiaoyao", szTimes = "TimesXiaoyao", szName = "Tiêu Dao Cốc", nRate = 30, nMaxTimes = 70},
	[2] = {szKey = "SalaryJunying", szTimes = "TimesJunying", szName = "Quân Doanh", nRate = 150, nMaxTimes = 14},
	[3] = {szKey = "SalaryBaotu", szTimes = "TimesBaotu", szName = "Tàng Bảo Đồ", nRate = 210, nMaxTimes = 10},
	[4] = {szKey = "SalaryJingji", szTimes = "TimesJingji", szName = "Thi đấu Gia tộc", nRate = 420, nMaxTimes = 5},
	[5] = {szKey = "SalaryDadao", szTimes = "TimesDadao", szName = "Truy nã Hải tặc", nRate = 30, nMaxTimes = 40},
	[6] = {szKey = "SalaryYijun", szTimes = "TimesYijun", szName = "Nhiệm vụ Nghĩa quân", nRate = 15, nMaxTimes = 80},
	[7] = {szKey = "SalaryGuanqia", szTimes = "TimesGuanqia", szName = "Vượt ải Gia tộc", nRate = 600, nMaxTimes = 2},
	[8] = {szKey = "SalaryZhongzhi", szTimes = "TimesZhongzhi", szName = "Trồng cây Gia tộc", nRate = 60, nMaxTimes = 20},
	[9] = {szKey = "SalaryChaqi", szTimes = "TimesChaqi", szName = "Cắm cờ Gia tộc", nRate = 15, nMaxTimes = 80},	
};
