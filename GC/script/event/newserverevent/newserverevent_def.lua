...
NewServerEvent.szAnnounceKinEvent = "<color=yellow>【新服庆喜家族活动】<color>已经开启，请族长前往各新手村<color=green>白秋琳<color>处领取<color=yellow>家族挑战令牌<color>，可以到野外地图进行家族BOSS的召唤。";
...
NewServerEvent.szAnnounceBefore 	= "小龙女即将出现在<color=green>临安府、大理府和襄阳府<color>，请大家做好准备，迎接小龙女的到来！";
NewServerEvent.szAnnounceBegin 		= "小龙女已经出现在<color=green>临安府、大理府和襄阳府<color>，请大家<color=yellow>跟随小龙女<color>，沾染喜气！";
NewServerEvent.szAnnounceEnd 		= "小龙女已经离开了城市，请期待小龙女下一次的到来！";
...
NewServerEvent.tbAwardList = {
	[1723] = {"bindcoin", 100, 0},
	[2739] = {"bindcoin", 150, 1723},
	[3295] = {"bindcoin", 200, 2739},
	[3333] = {"bindcoin", 400, 3295},
	[5056] = {"bindmoney", 10000, 3333},
	[6073] = {"bindmoney", 15000, 5056},
	[6629] = {"bindmoney", 20000, 6073},
	[6667] = {"bindmoney", 40000, 6629},
	[8167] = {"Exp", 30, 6667},
	[9167] = {"Exp", 45, 8167},
	[10000] = {"Exp", 60, 9167},
	}
