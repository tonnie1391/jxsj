...
NewBattle.KILLPOINTRULE =
{
	...
	["ZHANCHE"]		= {400,		0	, "Bạn phá hủy <color=yellow>Chiến Xa<color> nhận được <color=white>%d<color> tích lũy!"},
	["JIANTA"] 		= {400,		0	, "Bạn phá hủy <color=yellow>Tiễn Tháp<color> nhận được <color=white>%d<color> tích lũy!"},
	["PAOTAI"]		= {1000,	300	, "Bạn phá hủy <color=yellow>Pháo Tháp<color> nhận được <color=white>%d<color> tích lũy!"},
	["SHOUHUZHE"]	= {1000,	500	, "Bạn đánh bại <color=yellow>Thủ Hộ Giả<color> nhận được <color=white>%d<color> tích lũy!"},
	["LONGMAI"]	 	= {1000,	0	, "Bạn phá hủy <color=yellow>Long Mạch<color> nhận được <color=white>%d<color> tích lũy!"},
};
--守护积分，个人奖励
...
NewBattle.TIME_FIGHT				=	45 * 60 * Env.GAME_FPS;			--战斗时间
